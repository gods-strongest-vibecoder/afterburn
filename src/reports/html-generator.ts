...
import { redactSensitiveUrl, redactSensitiveData, escapeHtml } from '../utils/sanitizer.js';
 ...
 * Also escapes HTML entities to prevent XSS attacks.
 */
function redactSensitive(text: string): string {
  ...
  // Escape HTML entities to prevent XSS (defense-in-depth, Handlebars also auto-escapes)
...
export async function generateHtmlReport(
  ...
  const html = template({
    targetUrl: escapeHtml(redactSensitiveUrl(executionArtifact.targetUrl)),
