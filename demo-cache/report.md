...
tool: afterburn
version: "1.0"
session_id: f5d3f17f-bc83-4dcb-9d7d-951a33f45dfc
timestamp: 2026-02-09T16:18:48.453Z
...
| 2 | MEDIUM | Console Error | Page or resource not found | http://localhost:3847/images/icon-deploy.png |
| 3 | MEDIUM | Console Error | Page or resource not found | http://localhost:3847/images/icon-monitor.png |
| 4 | MEDIUM | Console Error | Page or resource not found | http://localhost:3847/images/icon-team.png |
| 5 | MEDIUM | Console Error | An image failed to load | http://localhost:3847/images/icon-deploy.png |
| 6 | MEDIUM | Console Error | An image failed to load | http://localhost:3847/images/icon-monitor.png |
| 7 | MEDIUM | Console Error | An image failed to load | http://localhost:3847/images/icon-team.png |
| 8 | MEDIUM | Console Error | Page or resource not found | http://localhost:3847/images/office-map.png |
| 9 | MEDIUM | Console Error | An image failed to load | http://localhost:3847/images/office-map.png |
| 10 | MEDIUM | Console Error | Server error | http://localhost:3847/api/data |
| 11 | MEDIUM | Console Error | Page or resource not found | http://localhost:3847/about |
| 12 | MEDIUM | Console Error | Page or resource not found | http://localhost:3847/blog |
| 13 | MEDIUM | Dead Button | Submit button doesn't do anything when clicked | http://localhost:3847 |
| 14 | MEDIUM | Dead Button | Submit button (contact form form) doesn't do anything when clicked | http://localhost:3847 |
| 15 | MEDIUM | Dead Button | "Get Started Free" button doesn't do anything when clicked | http://localhost:3847 |
| 16 | MEDIUM | Dead Button | "Subscribe" button doesn't do anything when clicked | http://localhost:3847 |
| 17 | MEDIUM | Dead Button | "Send Message" button doesn't do anything when clicked | http://localhost:3847 |
| 18 | MEDIUM | Dead Button | "Get Started" button doesn't do anything when clicked | http://localhost:3847 |
| 19 | MEDIUM | Dead Button | "Start Free Trial" button doesn't do anything when clicked | http://localhost:3847 |
| 20 | MEDIUM | Broken Form | A form on your site doesn't work when submitted (x2) | http://localhost:3847 (form.newsletter-form) |
| 21 | MEDIUM | Broken Form | A form on your site doesn't work when submitted (x2) | http://localhost:3847 (form#contact-form) |
| 22 | MEDIUM | Accessibility | Ensure the contrast between foreground and background colors meets WCAG 2 AA ... | http://localhost:3847/ |
| 23 | MEDIUM | Accessibility | Ensure every HTML document has a lang attribute | http://localhost:3847/ |
| 24 | MEDIUM | Accessibility | Ensure <img> elements have alternative text or a role of none or presentation | http://localhost:3847/ |
| 25 | MEDIUM | Accessibility | Ensure every HTML document has a lang attribute | http://localhost:3847/contact |
| 26 | MEDIUM | Accessibility | Ensure every HTML document has a lang attribute | http://localhost:3847/blog |
| 27 | MEDIUM | Accessibility | Ensure the contrast between foreground and background colors meets WCAG 2 AA ... | http://localhost:3847/pricing |
| 28 | MEDIUM | Accessibility | Ensure every HTML document has a lang attribute | http://localhost:3847/pricing |
| 29 | LOW | Console Error | JavaScript error: Failed to load resource: the server responded with a status... | http://localhost:3847/ |
| 30 | LOW | Console Error | JavaScript error: Failed to load resource: the server responded with a status... | http://localhost:3847/pricing |
| 31 | LOW | Console Error | JavaScript error: Failed to load FAQ: Error: API returned 500     at http://l... | http://localhost:3847/pricing |
...
*Generated by Afterburn v1.0 on 09.02.2026, 17:18:48*
